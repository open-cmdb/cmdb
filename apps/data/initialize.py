...
def add_serializer(table):
    ...
    for field in fields:
        ...
        # args["allow_null"] = not field.required
    ...
    # attributes["__init__"] = serializer_init
...
def add_viewset(table):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            res = es.create(index=data_index, doc_type="data", id=str(uuid.uuid1()).replace("-", ""), body=serializer.data)
